...
pdf2svg $SRC_FILE_PDF $DST_FILE_SVG 1>/dev/null 2>&1
echo -e "\t\t [ OK ]"
...
then
    ...
    inkscape --export-area-page --export-background=white --export-background-opacity=255 --export-width=600 \
            --export-type=png --export-filename=$DST_FILE_PNG_600 $DST_FILE_SVG 1>/dev/null 2>&1
    echo -e "\t\t [ OK ]"
    echo -n "Converting $DST_FILE_SVG to $DST_FILE_PNG_1200 ..."
    inkscape --export-area-page --export-background=white --export-background-opacity=255 --export-width=1200 \
            --export-type=png --export-filename=$DST_FILE_PNG_1200 $DST_FILE_SVG 1>/dev/null 2>&1
    echo -e "\t\t [ OK ]"
    echo -n "Converting $DST_FILE_SVG to $DST_FILE_PNG_1920 ..."
    inkscape --export-area-page --export-background=white --export-background-opacity=255 --export-width=1920 \
            --export-type=png --export-filename=$DST_FILE_PNG_1920 $DST_FILE_SVG 1>/dev/null 2>&1
    echo -e "\t\t [ OK ]"
    echo -n "Converting $DST_FILE_SVG to $DST_FILE_PNG_6000 ..."
    inkscape --export-area-page --export-background=white --export-background-opacity=255 --export-width=6000 \
            --export-type=png --export-filename=$DST_FILE_PNG_6000 $DST_FILE_SVG 1>/dev/null 2>&1
    echo -e "\t\t [ OK ]"
else
    echo -n "Converting $DST_FILE_SVG to $DST_FILE_PNG_600 ..."
