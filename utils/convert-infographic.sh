...
then
    ...
    inkscape --without-gui --export-area-page --export-background=white --export-background-opacity=255 --export-width=600 \
    ...
    inkscape --without-gui --export-area-page --export-background=white --export-background-opacity=255 --export-width=1200 \
    ...
    inkscape --without-gui --export-area-page --export-background=white --export-background-opacity=255 --export-width=1920 \
    ...
    inkscape --without-gui --export-area-page --export-background=white --export-background-opacity=255 --export-width=6000 \
