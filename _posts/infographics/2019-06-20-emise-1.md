...
caption:    "Zdrojová data: Eurostat. Graf znázorňuje rozložení celkových emisí skleníkových plynů (v tunách [CO2 ekvivalentu](http://fix.me)) v ČR za jeden rok v jednotlivých sektorech lidské činnosti."
...
- Podrobnější zobrazení emisí ČR viz graf FIXME
- Srovnání emisí států EU viz graf FIXME
- Srovnání emisí na obyvatele pro státy EU FIXME
- Srovnání emisí jednotlivých sektorů ČR na obyvatele s dalšími státy EU FIXME  

## Jak číst tento graf a co znamenají jednotlivé sektory?

- Roční objem emisí České republiky je 130,35 mil. tun (údaj z roku 2016). V přepočtu na obyvatele to je 12.3 tCO2eq/obyvatele. 
- __Energetika:__ Největší podíl CO2 ze všech sektorů má energetika, konkrétně 54,45 milionů tun, což je 41,8 % celkových emisí. Emise v energetice pochází především ze spalování hnědého uhlí v elektrárnách (33,6 milionů tun, nebo 25,8 % celkových emisí) a dále z teplárenství a výroby paliv (20,85 mil. tun, či 16 % celkových emisí). Největším jednotlivým emitentem CO2 je hnědouhelná elektrárna Počerady, která ročně vyprodukuje 5,84 mil. tun CO2, což je 4,48 % celkových emisí České republiky. Dvě největší české hnědouhelné elektrárny Počerady a Tušimice vyprodukují ročně téměř tolik emisí CO2, jak veškerá osobní automobilová doprava. Emise skleníkových plynů původem z energetiky je možné efektivně omezit energetickými úsporami a rozvojem obnovitelných a nízkouhlíkových zdrojů energie.
- __Doprava:__ Emise z dopravy činí v České republice 18,45 mil. tun CO2, což je 14,15 % celkových emisí. Osobní automobilová doprava vyprodukuje 10,86 mil. tun, což je 8,33 % celkových emisí (FIXME kolik je to km na osobu ročně?). Nákladní a autobusová doprava vyprodukuje 7,16 mil. tun CO2, což je 5,49 % celkových emisí. Vlaková doprava je v grafu započtena, ale je příliš malá na to, aby se zobrazila (305 tisíc tun CO2eq, což je 0.23% celkových emisí). Ačkoliv je letecká doprava celosvětově významným zdrojem emisí, je komlikované posoudit, kterým zemím by se měla započítat, proto ve vtšině údajů, které na internetu najdete není letecká doprava do emisí jednotivých zemí započítaná. Snížit emise z dopravy je možné přechodem na nízkouhlíková paliva (elektrickou energii, biometan, vodík...), zvýšením podílu vlakové a autobusové dopravy a snížením nutnosti přepravy (což může znamenat třeba bydet blíže práci). 
- __Průmyslové procesy:__ Emise z průmyslových procesů, při kterých dochází k uvolňování skleníkových plynů do atmosféry jinak než spalováním fozilních paliv - výroba cementu, výroba železa a oceli apod. - činí ročně 15,22 mil. tun, tedy 11,68 % celkových emisí České republiky. Konkrétní údaje jednotlivých položek: Výroba cementu a jiných minerálů 2.81 Mt resp. 2.16%; Chemický průmysl 1.52 Mt resp 1.17%; Výroba oceli a jiných kovů 7.31Mt resp. 5.61%; plyny pro chalzení a klimatizaci 3.09Mt resp 2.37%. 
...
- __Domácnosti a instituce__ jsou zodpovědné za 13,55 mil. tun emisí CO2 ročně, což reprezentuje 10,4 % celkových ročních emisí. Jde o topení a ohřev vody(pokud není z teplárny), vaření apod.  
