...
caption:    "Zdrojová data: Eurostat a data z emisních povolenek.DOPLNIT ODKAZY. Graf znázorňuje rozložení celkových emisí skleníkových plynů (v tunách [CO2 ekvivalentu](http://fix.me)) v ČR za jeden rok v jednotlivých sektorech lidské činnosti."
...
- Méně podrobné zobrazení emisí ČR viz graf FIXME
