...
const CostsBenefits = (() => {
  ...
  function calculate(options) {
    ...
    const baseOpts = { discountRate, carbonPriceEur, exchangeRate, electricityPriceFactor, globalPriceFactor, fossilMult, cleanMult, capexMeasMult, capexBlMult, fuelPriceName, fuelPriceMult };
