...
<div class="section intro">
    <div class="container clearfix">
        ...
        <p class="intro-buttons">
            ...
            <a href="https://2050podcast.cz/" class="btn btn-secondary no-ext-link-icon"><i class="fas fa-fw fa-headphones"></i> Podcast 2050</a>
            <a href="https://dekarbonizujemecesko.cz/" class="btn btn-secondary no-ext-link-icon"><i class="fas fa-graduation-cap fa- mr-1"></i> Online kurz dekarbonizace</a>
...
<div class="tab-content" id="myTabContent">
  <div class="section tab-pane fade show active bg-extralight-blue pt-4 pb-4" id="tab1" role="tabpanel" aria-labelledby="tab-role-1"><div class="container lead">
    <div class="row">
      <div class="col-md-6">
        <p>
        Otázka dekarbonizace je často spojená s jejími náklady. Avšak vypouštění emisí skleníkových plynů má také svoji cenu, jen mnohem méně zjevnou.
        </p>
        <p>
        Projevuje se třeba častějšími extrémy počasí, změnami v zemědělské produkci nebo dopady na lidské zdraví. Její vyčíslení se označuje jako <strong>společenské náklady uhlíku.</strong>
        </p>
        <p>
