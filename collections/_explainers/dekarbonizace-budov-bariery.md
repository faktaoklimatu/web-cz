...
Když se bavíme o sektoru budov v kontextu dekarbonizace, běžně máme na mysli činnosti, které souvisí především s jejich provozem, dále výstavbou a demolicí.
...
- vaření,
- svícení,
- pohon elektrospotřebičů (pračka, lednička, počítač, mobilní telefon, …),
- provoz výtahů nebo eskalátorů.

Výstavba následující:

- výrobu a dopravu stavebních materiálů (cement, ocel, dřevo, izolace atd.),
- výrobu nízkoemisních technologií (tepelná čerpadla, fotovoltaické panely, baterie),
...
Emise v sektoru budov je možné rozdělit na přímé a nepřímé:

- **Přímé** vznikají spalováním paliv – ať už jde o zemní plyn v lokálních kotlích nebo pevná paliva jako uhlí a dřevo v kamnech – pro vytápění nebo ohřev vody přímo v budovách a tvoří asi 10 % celkových emisí Česka.
- **Nepřímé** vznikají jednak spalováním fosilních paliv nebo biomasy při výrobě elektřiny nebo tepla v elektrárnách a teplárnách, které je následně dodáváno do domácností a kanceláří (asi 20 % českých emisí). Jednak při výrobě stavebních materiálů (procesní a spalovací) – cementu, vápna a (asi 5 % emisí Česka). Dále by sem spadá část emisí z výroby oceli nebo z přepravy a likvidace materiálů. Tyto emise lze označit i pojmem _zabudovaný uhlík_ (angl. _embodied carbon_). Celkem tak budovy v celém životním cyklu zaujímají **přibližně 35 % emisí skleníkových plynů Česka.**

## Bariéry dekarbonizace budov
...
## Kdo může bariéry řešit?

Možnost adresovat zmíněné bariéry mají především vláda a příslušná ministerstva (především MPO, MŽP a MMR) a vládní instituce. Dále kraje a obce. V dílčích případech pak instituce jako Český statistický úřad. Případně i soukromý sektor skrze... Nebo banky... *Bude rozepsáno šířeji.*
