...
Vláda ovšem nemusí pouze omezovat – může také podpořit rozvoj aktivit, které jsou pro dekarbonizaci žádoucí. Přijme například **opatření, které tyto aktivity umožní realizovat nebo sníží stávající bariéry k jejich realizaci.** Příklady:
...
Důležitým nástrojem vlády je i stanovení norem pro určité aktivity. Ty se mohou v čase zpřísňovat, ale i v tomto případě platí, že je potřeba jejich zavedení (případně změny) signalizovat s dostatečným předstihem, aby se jim podniky a domácnosti mohly úspěšně přizpůsobit. Příklady:
...
* Cíle pro jednotlivé členské státy EU ke snížení emisí mimo EU ETS v sektorech dopravy, budov, malého průmyslu a energetiky, zemědělství a odpadového hospodářství ([nařízení o sdílení úsilí](https://eur-lex.europa.eu/legal-content/CS/TXT/?uri=celex%3A32023R0857))
...
* [Systém EU pro obchodování s emisními povolenkami](https://faktaoklimatu.cz/explainery/emisni-povolenky-ets) (_Emission Trading System_, EU ETS), který zpoplatňuje každou tunu emisí vyprodukovanou nejvíce znečišťujícími sektory (jako výroba elektřiny, těžký průmysl nebo letecká doprava). Dotčené podniky si za každou tunu emisí musí koupit povolenku, jejíž cenu určuje mechanismus nabídky a poptávky a zároveň je pro obchodované emisní povolenky stanoven cenový strop (princip _cap-and-trade_). Množství povolenek v oběhu se nicméně postupně snižuje, aby mohlo být dosaženo předem stanoveného emisního cíle.[^14] [^15]
...
* [Mechanismus uhlíkového vyrovnání na hranicích](https://eur-lex.europa.eu/legal-content/CS/TXT/HTML/?uri=CELEX:32023R0956) (_Carbon Border Adjustment Mechanism_, CBAM) neboli tzv. uhlíkové clo, kterým EU od roku 2026 zpoplatní dovozy emisně intenzivních produktů do EU. Tím dojde k narovnání trhu pro domácí výrobce, kteří podléhají povinnosti nakupovat emisní povolenky, a byli by tak nevýhodě oproti producentům ze zemí mimo EU.
...
* Státní podpora bezemisních zdrojů energie (aukce, feed-in tarify, contracts for difference[^23]), která výrobcům dodává ujištění (v podobě smlouvy) o návratnosti jejich investice. V Česku takto funguje podpora obnovitelných zdrojů energie, kterou upravuje [zákon č. 469/2023 Sb.](https://www.e-sbirka.cz/sb/2023/469) Tato podpora přitom nabývá např. formy garantované výkupní ceny za vyrobenou jednotku elektřiny po dobu několika let.

## Informační nástroje

**Dostupné informace pomáhají k lepším rozhodnutím** na různých úrovních. Samotné informační nástroje mohou mít mnoho podob a umožňovat předávání informací mezi různými aktéry (stát → podniky, stát → občané, podniky → občané atd.).
...
Kampaně se mohou zaměřovat buď na přiblížení dekarbonizace jako celku, nebo mohou informovat o možnostech v určité oblasti – např. o možnostech snížení energetické náročnosti bydlení a navazujících dotačních programech. Mezi takové nástroje patří například:
...
[^4]: Často diskutovaný konec aut produkujících emise CO<sub>2</sub> po roce 2035 je dobrým příkladem. Regulace byla přijata více než s desetiletým předstihem, navíc je její náběh [postupný](https://climate.ec.europa.eu/eu-action/transport/road-transport-reducing-co2-emissions-vehicles/co2-emission-performance-standards-cars-and-vans_en?prefLang=cs) s průběžným zpřísňováním emisních norem v letech 2025–2029 a 2030–2034.

[^5]: Limity mají počátek v roce 1991, kdy bylo vydáno [usnesení](https://kormoran.vlada.cz/usneseni/usneseni_webtest.nsf/0/7DCED4838DD30F36C12571B6006B9ABD) tehdejší vládou Petra Pitharta. V roce 2008 vláda Mirka Topolánka v [usnesení](https://odok.cz/portal/services/download/attachment/2008/1176/PDF/) upravila limity v dole Bílina a vláda Bohuslava Sobotky je v roce 2015 prolomila ve prospěch další těžby.
...
[^15]: Systémy pro obchodování s emisními povolenkami [fungují](https://carbonpricingdashboard.worldbank.org/compliance/instrument-detail) i jiných zemích světa – např. v Číně, Velké Británii, Novém Zélandu a jinde.
...
[^23]: Contracts for difference fungují například v Německu, kdy producentům elektřiny garantují výkupní cenu ve smyslu, že pokud je smluvená cena nižší než současná tržní cena, rozdíl připadne kupujícímu elektřiny (v opačném případě kupující doplatí producentovi rozdíl v ceně).
