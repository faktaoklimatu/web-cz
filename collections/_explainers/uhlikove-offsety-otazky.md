...
- Za jak dlouho slíbený efekt nastane?
...
Podobně jako nikdo neplatí za to, že každé ráno vyjde slunce, protože k tomu dojde tak jako tak, i v případě offsetového projektu je vždy třeba se ptát, zda jeho financování není zbytečné – protože k žádné další sekvestraci uhlíku už díky němu nedochází. **Přidaná hodnota (adicionalita)** takového projektu je pak nulová.  

V souvislosti s přidanou hodnotou je vhodné si položit tyto tři otázky:

**Nejde o dlouhodobý projekt, jehož pokračování na prodeji kreditů nijak nezávisí?**
{% include expander-figure.html
    name="offsety-kratkodobe_dlouhodobe"
    class="contrast-figure"
    label="Příklad: Farmář využívající praktiky regenerativního zemědělství"
    content="
Farmář na svém pozemku už několik let využívá principy regenerativního zemědělství. Uvědomí si, že tím přispívá ke snižování koncentrace skleníkových plynů v atmosféře, a rozhodne se, že začne prodávat uhlíkové kredity. Takový projekt se na odstraňování uhlíku z atmosféry nepochybně podílí, nicméně až dosud fungoval i bez financování z prodeje offsetů, a ani jeho pokračování tedy na této podpoře nezávisí.
"
%}
...
{% include expander-figure.html
    name="offsety-kratkodobe_dlouhodobe"
    class="contrast-figure"
    label="Příklad: Lesy v České republice"
    content="
Někdo se v Česku rozhodne, že na pozemku určeném k plnění funkce lesa vysází stromy. Obnova lesa je ovšem povinností vlastníka pozemku, jež vyplývá z českého lesního zákona – prodej uhlíkových offsetů tedy žádnou další redukci skleníkových plynů nepřináší. Stromy by byly vysazeny v každém případě.
"
%}
**Není stejný efekt financován opakovaně či z více zdrojů?**
{% include expander-figure.html
    name="offsety-kratkodobe_dlouhodobe"
    class="contrast-figure"
    label="Příklad: Ochrana mokřadního biotopu"
    content="
Cílem offsetového projektu je obnova mokřadního biotopu (kvůli ochraně vzácných druhů mechorostů), která je financována z projektu místního ochranářského spolku. Je-li projekt dostatečně financován z jiných zdrojů, ani v tomto případě tedy prodej uhlíkových kreditů už další redukci emisí skleníkových plynů nepřináší.
"
%}

## Má projekt další pozitivní přínosy?
Kromě ukládání uhlíku mohou mít kvalitní offsetové projekty i další přínosy, třeba pro místní ekosystém nebo pro příjemnější pobyt v krajině. Aleje (zejména pokud jde o druhy stromů, které zde přirozeně rostou) podporují biodiverzitu, hnízdí v nich ptáci a poskytují stín. Druhově a věkově pestré lesy jsou pro biodiverzitu také příznivé, navíc regulují klima v dané oblasti a napomáhají zádrži vody v krajině. Postupy regenerativního zemědělství zase zlepšují půdní strukturu a schopnost půdy zadržovat vodu. Všechny tyto přínosy jsou hodnotné samy o sobě, zároveň však často i pomáhají přírodě adaptovat se na probíhající změny klimatu. Jejich podporou je tedy možné podpořit kromě mitigace také adaptaci. 
