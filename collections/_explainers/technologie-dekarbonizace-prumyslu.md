...
[^ccs]: [Energetické nároky CCS](https://www.sciencedirect.com/science/article/pii/S1876610213003603) znamenají spotřebu 250-300 kWh za každou zachycenou tunu CO2. Stlačení CO2 vyžaduje dalších 80-120 kWh za tunu CO2. Při kalcinaci při výrobě cementu v Česku se ročně uvolní asi 1,9 Mt CO<sub>2</sub>, tedy jeho zachycení a stlačení by vyžadovalo navíc asi 0,75 TWh elektřiny ročně (asi 1 % spotřeby celé ČR, ovšem více než 100% současné spotřeby v cementárnách).
...
[^cirkularita]: [Mezi další problémy může patřit mimo jiné chování firem či spotřebitelů](https://hbr.org/2021/06/the-limits-of-the-sustainable-economy).
