...
{% include figure.html
    ...
    alt="Diagram tří aspektů biodiverzity – vymíraní druhů, snižování druhé pestrosti a stírání rozdílů mezi různými místy."
...
1. [__Ubývání biotopů__](#ubývání-biotopů) – především v důsledku intenzivního zemědělství a s ním spojených změn v krajině (například kácení pralesů kvůli novým polím a plantážím).
2. [__Nadměrná exploatace__](#nadměrná-exploatace), tedy intenzivní lov savců, ryb a dalších živočichů – mnohé druhy jsou proto dnes v ohrožení.[^5]
3. [__Vysoká míra znečištění__](#vysoká-míra-znečištění) daná používáním jedů proti škůdcům a plevelům.
4. [__Šíření nepůvodních druhů__](#šíření-exotických-druhů) – ty konkurují původní fauně a flóře a často ji vytlačí či vyhubí.
5. [__Klimatická změna__](#klimatická-změna) – nejvíce ohroženy jsou druhy v neobvyklých klimatických podmínkách.
...
{% include figure.html
    ...
    source-text="Andy Morffew, licence <a href='https://creativecommons.org/licenses/by/2.0/deed.cs'>CC BY 2.0</a>, a Alun Williams333, <a href='https://creativecommons.org/licenses/by-sa/4.0/deed.cs'>CC BY-SA 4.0</a>, obojí prostřednictvím Wikimedia Commons."
%}
...
- __nebude dále zvyšovat koncentraci dusíku a fosforu nadměrným hnojením__ a
- __nebude zamořovat půdu a vodu jedovatými přípravky proti škůdcům a plevelům__.
