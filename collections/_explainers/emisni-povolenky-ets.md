...
* Vznikl **nový systém** obchodování s emisními povolenkami **pro sektor silniční dopravy a sektor budov** (tzv. EU ETS 2) od roku 2027. Emise skleníkových plynů v těchto sektorech mají do roku 2030 klesnout o alespoň 43 % (ve srovnání s rokem 2005).
* Vznikl **Sociální klimatický fond**, z jehož prostředků budou podporovány zranitelné skupiny obyvatel (například nízkopříjmové domácnosti) a malé a střední podniky, pro které dekarbonizace představuje největší výzvu. Fond bude financován výnosy z prodeje povolenek v tomto systému. Česku z fondu připadne přibližně 50 miliard korun.
