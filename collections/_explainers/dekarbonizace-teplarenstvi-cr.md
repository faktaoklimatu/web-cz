...
- **Transformaci tepláren často komplikuje složitá vlastnická struktura.** Např. rozvody tepla mají v mnoha případech jiného vlastníka než výrobní zařízení. Ve vlastnické struktuře jsou mnohdy jak soukromí vlastníci, tak další subjekty (například část majetku je soukromá a část patří městu). Různí vlastníci navíc mají často protichůdné motivace, a tak může být obtížné se dohodnout na dlouhodobém směřování i na načasování změn.
