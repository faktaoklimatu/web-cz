---
layout:      explainer
title:       "Jak spolehlivě v Česku vyrábí elektřinu solární a větrné zdroje?"
slug:        "promenlivost-oze"
...
cover-source-url:           "https://unsplash.com/photos/landscape-photography-of-grass-field-with-windmills-under-orange-sunset-lsJ9jHKIqHg"
perex: |
...
- **Období velmi nízké výroby v Česku nastávají** v zimních měsících, když je souběžně zamračeno a málo fouká vítr. V zimní polovině roku bývá průměrně 24 dní, kdy vítr vyrobí méně než čtvrtinu dlouhodobého průměru. Pro taková období jsou potřeba **záložní zdroje**, příp. sezónní akumulace.
...
1. **Sezónní** pohled. V jakém rozsahu se pohybuje výroba po měsících nebo po rocích? Při vhodné kombinaci instalovaných výkonů se slunce a vítr v ročním a sezónním horizontu dobře doplňují – v období, kdy málo svítí slunce, typicky více fouká vítr a naopak. V měsíčních součtech se spolehlivě vyrobí X % dlouhodobého průměru.
2. **Den ode dne** je výroba ze slunce a větru poměrně dobře předvídatelná, ale i tak se přirozenými vlivy každý den do různé míry mění. Jednou za čas, Xkrát do roka, (nejčastěji mezi listopadem a lednem) nastávají období, kdy málo svítí slunce i málo fouká vítr, tzv. *Dunkelflaute*. Pro tyto případy je nutné mít dostatek **záložních zdrojů**, příp. dostatek kapacit pro akumulaci energie.
...
V jednotlivých dnech roku je výroba z OZE proměnlivá, avšak není zcela nahodilá. V letní polovině roku v Česku nastává obvykle 10–20 dní, kdy se ze slunce vyrobí méně než polovina dlouhodobého průměru. Pod 25 % se typicky vyrobí pouze ve třech dnech ze 183, tedy přibližně jednou za dva měsíce.

Kvůli větší přirozené variabilitě jsou u větru tyto počty násobně vyšší. Denní výroba klesá v Česku v zimní polovině roku pod 50 % průměrně 55krát, tedy asi dvakrát za týden. Pod jednu čtvrtinu průměru klesá výroba průměrně 24krát, tedy přibližně jednou za týden.

<!-- TODO: Vyladit tabulku -->

{:.table}
| | Slunce<br><span class="small text-muted">v letní polovině roku</span> | Vítr<br><span class="small text-muted">v zimní polovině roku</span> |
|-------------------------|-----:|-----:|
| Celkem dní              |  183 | 183,25 |
| Dny pod 50 %            | 15,2 | 55,1 |
| Dva a více dní pod 50 % |  7,6 | 43,7 |
| Tři a více dní pod 50 % |  3,7 | 33,1 |
| Dny pod 25 %            |  2,9 | 24,0 |
| Dva a více dní pod 25 % |  0,8 | 15,1 |
| Tři a více dní pod 25 % |  0,2 |  8,6 |
...
Právě v těchto dnech potřebuje energetická soustava záložní zdroje, které 90 nebo i 98 % času stojí, ale jednou za čas jsou potřeba pro zajištění spolehlivých dodávek elektřiny (a tepla). Výroba z těchto zdrojů může být nákladná, ale jejich výstavba je oproti jiným konvenčním zdrojů relativně levná. Výstavba těchto zdrojů i vyjímečná (byť nákladná) výroba ale v součtu příliš celkové náklady na provoz elektrizační soustavy neovlivní.

Příklad takového období ukazuje následující graf výroby z OZE (žluté a zelené plochy) a spotřeby (černá křivka) v Německu v lednu 2025. Několik dní po sobě panovalo silné bezvětří a v některých dnech i oblačnost.
...
- Výroba je ve většině dní relativně vysoká a nepravidelně klesá k nízkým hodnotám (jako třeba pod 50 % průměrné výroby). Zároveň téměř nikdy nestoupá nad hranici 160 % průměru.[^zesikmeni-slunce] Je to dáno podnebím ve střední Evropě a technologií výroby elektřiny ze slunečního záření.
...
Konkrétní příklad výroby z fotovoltaiky v letní půlce roku ukazuje následující graf (podle počasí roku 2009). Šedé body ukazují kolísání výroby den ode dne – ve většině dní se pohybuje blízko průměru. Přibližně jednou za 12 dní se objeví den s výrobou pod 50 %, ale téměř vždy následuje den, který je opět blíže průměru. Výjimkou jsou zde například dva horší dny uprostřed května.
...
Pro snazší srovnání napříč roky je užitečné se místo výroby den po dni dívat na klouzavý průměr – žlutá křivka v grafu ukazuje průměr výroby v sedmi po sobě jdoucích dnech. Pro zhodnocení realistického rozsahu variability je důležité se dívat na výrobu napříč mnoha roky. Proto následující graf ukazuje výrobu v pěti různých, náhodně vybraných letech.[^roky-pocasi-slunce]
...
Přebytky, tedy elektřina, která se okamžitě nespotřebuje, lze do nějaké míry akumulovat (v bateriích, přečerpávacích vodních nádržích apod.) a využít v následujících dnech. Technologie akumulace (zejména lithiové baterie) ale zatím nejsou dostatečně levné na to, aby se solární výrobě s akumulací dala postavit celá elektroenergetika, a to ani v letních měsících.

Náklady na výstavbu fotovoltaických elektráren, které by i za méně příznivých lét vyrobily dostatek přebytků, a dostatku baterií, které by tyto přebytky absorbovaly a přenesly nejméně slunečných dní, by jen pro Česko při současných cenách byly astronomické. Proto je nezbytné stavět bezemisní energetiku na pestrém mixu různých technologií, které se navzájem doplňují a posilují – slunce, vítr a jádro, doplněné flexibilní spotřebou, dobře dimenzovanou akumulací a záložními zdroji.
...
2. **Akumulace elektřiny** (tedy zejména baterie, přečerpávací vodní elektrárny nebo akumulační vodní nádrže) pomáhá s vyrovnáváním spotřeby a výroby v řádu hodin až dnů. Spolu se správným poměrem solárních a větrných zdrojů pro optimální sezónní výrobu je potřeba vhodně dimenzovat i kapacity akumulace (relativně k výkonům OZE), aby se s co nejmenšími náklady dalo co nejvíce přebytků přenést do dnů s nízkou výrobou.
    Technologie akumulace s vysokým poměrem kapacity ku instalovaném výkonu (nad 100 h) by umožnila přenášet energii až na úrovni jednoho týdne a pomohla by tak ještě efektivněji integrovat velké množství OZE. Taková technologie ale zatím není dostupná v dostatečné škále a dostatečně levně.
3. **Akumulace tepla a chladu** v systémech zásobování teplem, v domácnostech i průmyslu. V období nadbytku lze velké přebytky elektřiny z větru či fotovoltaiky použít pro ohřev vody v obřích zásobnících (pomocí elektrokotlů nebo tepelných čerpadel) a ukládat tak energii pro zásobování teplem v obdobích s nižší obnovitelnou výrobou. Podobně lze využívat tepelnou kapacitu budov nebo zařízení, například chladírna se může v hodině s velkými přebytky nachladit o něco více než obvykle a předejít tak spotřebě třeba ve večerní špičce.
4. Flexibilita spotřeby, např. při nabíjení elektroaut a v domácnostech. Elektroauto se může levněji nabít v poledne, kdy hodně vyrábí fotovoltaika, nebo uprostřed noci, kdy je jinak velmi nízká spotřeba. Podobně domácí spotřebiče nebo baterie mohou flexibilně reagovat na aktuální ceny elektřiny (a tedy přebytky nebo nedostatky elektřiny v síti).
...
[^roky-pocasi-slunce]: Jde o historické počasí let XX, YY.
