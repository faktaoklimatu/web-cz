...
V roce 2050 může technologie CCS či beton vytvrzený uhlíkem představovat přibližně 45% snížení emisí ve srovnání s emisemi z cementu vyráběného dnes.[^cementsnizeni]
...
Se sklem se setkáváme každý den a nejčastěji ve formě obalů či oken. Sklo se ovšem dá využít i v rámce dekarbonizace. Dvojitě či trojitě zasklená okna a izolující skelnou vatu potřebujeme pro snížení tepelných ztrát budov. Sklo je součástí solárních panelů kde tvoří výraznou část jeho hmotnosti a zároveň i podílu spotřebu energie při výrobě solárního panelu. Sklo najdeme i ve větrných turbínách v podobě skleněných vláken. Ta se používají rovněž v automobilovém průmyslu coby náhrada za těžší materiály.
...
[^cementcenazachyceni]: Na základě výpočtů [Mezinárodní energetické agentury](https://www.iea.org/commentaries/is-carbon-capture-too-expensive) se náklady na zachytávání CO<sub>2</sub> v případě výroby cementu pohybují v rozmezí 55-110 eur (1300-2600 českých korun) za zachycenou tunu CO<sub>2</sub>. Což je značná částka vzhledem k tomu, že na tunu cementu vzniká podle [Mezinárodní energetické agentury](https://www.iea.org/reports/cement) průměrně 0.59 tun CO<sub>2</sub> a tuna cementu [na trhu](https://www.daibau.cz/clanek/196/bily_cement) stojí (bez CCS) přibližně 100-125 eur (2400-3000 českých korun).
[^cementsnizeni]: Ve scénáři dekarbonizace od [McKinsey](https://www.mckinsey.com/industries/chemicals/our-insights/laying-the-foundation-for-zero-carbon-cement) je tak CCS hlavní metodou dekarbonizace cementu.
[^cementpaliva]: Náhrada fosilních paliv biomasou či odpady je ovšem pouze částečné řešení. Při masovém přechodu na biomasu by mohl být problém s jejím nedostatkem. Snížení emisí zároveň není dostatečné a existuje určitá míra nejistoty ohledně efektivity těchto kroků.
[^cementefektivita]: Podle [McKinsey](https://www.mckinsey.com/industries/chemicals/our-insights/laying-the-foundation-for-zero-carbon-cement) potenciál snížení emisív důsledku zvýšení efektivity je tlumen tím, že v minulosti již ke zvyšování efektivity docházelo.
...
[^hybridnipece]: Podle [British Glass](https://www.britglass.org.uk/sites/default/files/British%20Glass%20-%20Net%20Zero%20Strategy.pdf) výhodou hybridních pecí je případná možnost upravovat podíly zemního plynu a elektřiny v závislosti na tom jak jsou výhodné, s postupujícím časem mohou výrobci zvyšovat podíl elektřiny.
...
[^sklovodik]: Ve [sklářském průmyslu](https://www.britglass.org.uk/sites/default/files/British%20Glass%20-%20Net%20Zero%20Strategy.pdf) probíhá také vyvoj hybridních pecí, které by dovedly využívat vodík i zemní plyn, ovšem výzkum probíhá i na kompletním nahrazení zemního plynu vodíkem.
...
[^sklosuroviny]: Zde se opět může narážet na případný nedostatek materiálu či možnost změny vlasnosti vyrobeného skla podle [výrobců](https://www.britglass.org.uk/sites/default/files/British%20Glass%20-%20Net%20Zero%20Strategy.pdf).
...
[^spotreba]: Dle [Světového ekonomického fóra](https://www3.weforum.org/docs/WEF_NetZero_Industry_Tracker_2022_Edition.pdf) existuje nedostatek alternativ k využívání betonu a cementu.
[^pultuna]: [Jedná se o globální průměr](https://iea.blob.core.windows.net/assets/7f8aed40-89af-4348-be19-c8a67df0b9ea/Energy_Technology_Perspectives_2020_PDF.pdf) Spotřeba cementu na osobu se ovšem výrazně liší napříč světem.
[^infrastruktura]: Rostoucí spotřebu ovlivňuje právě přítomnost cementu v naprosto základních stavbách dle [Mezinárodní energetické agentury](https://iea.blob.core.windows.net/assets/7f8aed40-89af-4348-be19-c8a67df0b9ea/Energy_Technology_Perspectives_2020_PDF.pdf). I v rámci energetické tranzice se může vyskytnout zvýšená poptávka po materiálech, například pro železobetonové základy větrných turbín. 
...
[^cementintenzita]: Pro naplění Net Zero Scenario [Mezinárodní energetické agentury](https://www.iea.org/reports/cement) by emisní intenzita cementu měla roku 2030 být na úrovni 0,43 tun CO<sub>2</sub> na tunu vyrobeného cementu.
[^cementstoupajiciintenzita]: Hlavním důvodem pro nárůst emisní intenzity bylo navýšení poměru slínku k cementu na 0.72 dle [Mezinárodní energetické agentury](https://www.iea.org/reports/cement).
[^emisevapno]: Tento poměr je relativně obecně platný v rámci [vápenářského průmyslu](https://www.hycapgroup.com/this-global-first-sees-industrial-lime-produced-with-clean-hydrogen-in-uk/).
...
[^sklarnycr]: Částečná elektrifikace se prosadila i v některých [českých sklárnách](https://www.efotovoltaika.cz/tradicni-ceska-sklarna-zachranila-svou-existenci-a-vyrobu-diky-fotovoltaice-brutalni-zvyseni-ceny-za-plyn-vyresily-solary/), které takto zejména během výrazného navýšení cen zemního plynu roku 2022 dovedly ušetřit díky vlastní instalaci solárních panelů.
[^netzero]: 75 procentní pokles je součástí scénáře [McKinsey](https://www.mckinsey.com/industries/chemicals/our-insights/laying-the-foundation-for-zero-carbon-cement), který by měl být kompatibilní s cílem Pařížské dohody o omezení oteplení na 1,5 °C ve srovnání s teplotou před průmyslovou revolucí.
