...
tags-scopes: [ ]
tags-topics: [ ]
cover-source-author:        "Lukáš Lehotský"
cover-source-text:          "Unsplash"
cover-source-license:       "Unsplash License"
cover-source-license-url:   "https://unsplash.com/license"
cover-source-url:           "https://unsplash.com/photos/H6bwjGfWd7I"
perex:       "Ačkoli systém umožňující produkci a dodávky elektřiny vnímáme někdy jako neměnný a “přirozený”, ve skutečnosti prošel do dnešních dnů dlouhým vývojem. Pro pochopení aktuálních debat v Česku i v Evropské unii o možných změnách v oblasti výroby a distribuce elektřiny může být užitečné si tento vývoj trochu přiblížit. Následující text ukazuje, jak se dva základní přístupy v energetice měnily v průběhu let. Hraje hlavní roli stát, nebo trh? Kdo elektřinu dodává a pro koho? S jakým cílem a za jakých podmínek? Odpovědi na tyto otázky se v průběhu let mění, nicméně v mnoha zemích byl vývoj podobný. Platí to i o České republice, kde se i přes specifikum komunistického režimu v letech 1948–1989 z větší části podobal vývoji jinde v Evropě.[^francie]"
---
...
Dobře je rozdíl mezi tržním a státním přístupem vidět na příkladu jaderných elektráren. S jejich výstavbou jsou spojeny obrovské kapitálové náklady, které mají navíc velmi dlouhou návratnost. [^navratnost]
...
V jednotlivých zemích dochází k integraci národní energetiky s evropským trhem a zavádění energetických balíčků EU, které liberalizaci trhů dále prohlubují a tím posilují konkurenčnost prostředí a přeshraniční obchodování na burzách. Národní monopoly po celé Evropě tak postupně ztrácejí svou sílu. V Unii se zároveň zavádí systém emisních povolenek EU ETS<glossary id="euets">Pařížské dohodě</glossary>, který má pomoci výrobu elektřiny dekarbonizovat. Do popředí se také dostává otázka, jak při této výrobě přestat být závislý na fosilních zdrojích – státy například stanovují, do kdy mají uhelné elektrárny ukončit svůj provoz.
...
[^navratnost]: V kombinaci s nejistotou ohledně budoucí ceně elektřiny v liberalizovaných trzích to znamená, že [u financování jaderných elektráren existuje větší nejistota než v regulovaném trhu](https://www.iaea.org/sites/default/files/18/07/financing-np-0418.pdf).
[^cez]: [Stát může mít lepší podmínky půjčky](https://www.irozhlas.cz/ekonomika/cez-jaderna-elektrarna-dukovany_2203220819_ako) například z hlediska nižších úrokových sazeb oproti soukromým firmám.
...
[^elektrifikace]: [438/1919 Sb.](https://www.irozhlas.cz/ekonomika/cez-jaderna-elektrarna-dukovany_2203220819_ako) Zákon ze dne 22. července 1919 o státní podpoře při zahájení soustavné elektrisace.
...
[^akcie]: [Zbytek akcionářů](https://www.cez.cz/cs/o-cez/cez/akcionari)
[^ceps]: [Vyčlenění ČEPS](https://zpravy.aktualne.cz/denik-insider/zrozeni-imperia-skutecny-pribeh-spolecnosti-cez/r~i:insider:article:17913/)
...
[^ranking]: Pokusem o kvantifikaci toho, jak jednotlivé státy tyto potřeby balancují, je [*World Energy Trilemma Index*](https://www.worldenergy.org/assets/downloads/World_Energy_Trilemma_Index_2022.pdf?v=1669842216) od World Energy Council. Česká republika v tomto indexu obsadila 12. místo (z 91 hodnocených zemí). Na prvních třech pozicích se umístily Švédsko, Švýcarsko a Dánsko.
[^utilitizationgap]: Tento časový nesoulad, kdy budeme mít více zdrojů, než kolik dokážeme využít a zároveň nebude dostatek akumulace například prostřednictvím baterií, se anglicky nazývá *utilization gap*.
...
[^akcionari]: Podobná otázka se řeší například také ve Francii: zde byla energetická firma EdF v minulosti částečně privatizována, dnes [se znovu objevuje snaha](https://www.reuters.com/business/energy/france-keeps-edf-buyout-offer-12-euros-per-share-filing-2022-10-04/)
