...
- Dodavatelé, kteří již podléhají vnitrostátní uhlíkové dani, která je vyšší než průměrná cena povolenky, budou moci být od povinnosti vyřadit povolenky osvobozeni.
- S ohledem na to, že v dotčených sektorech téměř neexistuje riziko úniku uhlíku (tedy přesunu výroby do zemí s nižšími emisními standardy, a tudíž nižšími náklady na platby za znečištění), nebude docházet k alokaci povolenek zdarma (ty v rámci ETS 1 dostává např. těžký průmysl[^cbam]).
