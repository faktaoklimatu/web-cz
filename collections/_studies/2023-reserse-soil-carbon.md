    ...
    - name: Laser-induced breakdown spectroscopy (LIBS) to measure quantitatively soil carbon with emphasis on soil organic carbon. A review. Senesi & Senesi, 2016
      ...
      description: |
        ...
        * Výhody LIBS oproti dvěma nejčastěji používaným metodám měření uhlíku v půdě (*dry combustion* a *wet combustion*): 
            ...
            * b) nenarušuje půdu
            * c) měření je jednoduché a rychlé, což umožňuje provést velký počet měření v krátké době
...
<table class="table table-striped table-hover mt-4 mb-4">
  ...
  <tbody>
    {% for item in page.items.sekvestracepopis %}
    <tr>
      <td class="align-middle font-weight-bold">
        <a href="{{ item.link }}">{{ item.name }}</a>
      </td>
...
<table class="table table-striped table-hover mt-4 mb-4">
  ...
  <tbody>
    {% for item in page.items.faktorypopis %}
    <tr>
      <td class="align-middle font-weight-bold">
        <a href="{{ item.link }}">{{ item.name }}</a>
      </td>
...
<table class="table table-striped table-hover mt-4 mb-4">
  ...
  <tbody>
    {% for item in page.items.vlivpopis %}
    <tr>
      <td class="align-middle font-weight-bold">
        <a href="{{ item.link }}">{{ item.name }}</a>
      </td>
...
<table class="table table-striped table-hover mt-4 mb-4">
  ...
  <tbody>
    {% for item in page.items.kapacitapopis %}
    <tr>
      <td class="align-middle font-weight-bold">
        <a href="{{ item.link }}">{{ item.name }}</a>
      </td>
...
<table class="table table-striped table-hover mt-4 mb-4">
  ...
  <tbody>
    {% for item in page.items.merenipopis %}
    <tr>
      <td class="align-middle font-weight-bold">
        <a href="{{ item.link }}">{{ item.name }}</a>
      </td>
...
<table class="table table-striped table-hover mt-4 mb-4">
  ...
  <tbody>
    {% for item in page.items.typypopis %}
    <tr>
      <td class="align-middle font-weight-bold">
        <a href="{{ item.link }}">{{ item.name }}</a>
      </td>
...
<table class="table table-striped table-hover mt-4 mb-4">
  ...
  <tbody>
    {% for item in page.items.sicpopis %}
    <tr>
      <td class="align-middle font-weight-bold">
        <a href="{{ item.link }}">{{ item.name }}</a>
      </td>
...
<table class="table table-striped table-hover mt-4 mb-4">
  <tbody>
    {% for item in page.items.iniciativa %}
    <tr>
      <td class="align-middle font-weight-bold">
        <a href="{{ item.link }}">{{ item.name }}</a>
      </td>
...
<table class="table table-striped table-hover mt-4 mb-4">
  ...
  <tbody>
    {% for item in page.items.iniciativapopis %}
    <tr>
      <td class="align-middle font-weight-bold">
        <a href="{{ item.link }}">{{ item.name }}</a>
      </td>
