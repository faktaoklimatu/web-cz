...
download:         "Full text of the policy paper in PDF"
organizations:
...
authors:
  ...
  - id: "jan-krcal"
  - ids: ["marcel-otruba"]
    minor-role: "layout and design"
  - name: "Roman Blahynka"
    minor-role: "proofreading"
type:             "Policy paper"
perex: |
...
{% include preview-box.html
    title="Introduction to capacity markets"
    text="The basic principles of capacity markets are covered in our explainer (in Czech)."
...
{% include figure.html name="02-clarity.svg" alt="Pictogram: Strategic clarity" no-lightbox=true %}
...
{% include figure.html name="03-transparency.svg" alt="Pictogram: Transparency" no-lightbox=true %}
...
{% include figure.html name="04-no-more-gas.svg" alt="Pictogram: No more gas plants than necessary" no-lightbox=true %}
