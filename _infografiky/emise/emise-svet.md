...
* Česká republika produkuje 0,14 gigatun CO<sub>2</sub>eq ročně, to odpovídá 0,3&thinsp;% světových emisí při 0,15&thinsp;% globální populace. Pokud by každý obyvatel země produkoval tolik emisí jako průměrný Čech, globální emise by vzrostly na 92 gigatun CO<sub>2</sub>eq ročně, tedy na dvojnásobek současných emisí.
