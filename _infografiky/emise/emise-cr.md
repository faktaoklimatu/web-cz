...
- Roční objem emisí České republiky je 130,35 mil. tun {% include glossary.html id='co2eq' %} (údaj z roku 2016). __V přepočtu na obyvatele to je 12,3 tCO<sub>2</sub>eq/obyvatele.__
