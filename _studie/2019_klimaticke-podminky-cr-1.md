...
summary: |
    ...
    * __Pokud lidstvo emise skleníkových plynů do roku 2050 zásadně neomezí, ke konci tohoto století pak lze očekávat oteplení o 3 až 6 °C oproti současnosti.__ (emisní scénář {% include glossary.html id='rcp' %}8.5 FIXME)
    ...
    * V létě porostou počty tzv. tropických dnů, kdy maximální teplota dosáhne alespoň 30 °C. Nejhorší emisní scénář {% include glossary.html id='rcp' %}8.5 FIXME by znamenal __na konci století průměrně 30 tropických dnů za rok__ (v letech 1981–2010, bylo v průměně 8 tropických dnů za rok). Extrémní teploty vedou ke zvýšenému odparu vody z krajiny, což je jednou z hlavních příčin současného sucha.
