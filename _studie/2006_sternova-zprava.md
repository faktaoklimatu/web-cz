...
weight:     1
tags:       [ studie, svet ]
caption:    "Ekonomická analýza dopadů klimatických změn a nákladů na snížení emisí z roku 2006 na zakázku britské vlády."
intro:      "Ekonomickou analýzu dopadů klimatických změn a nákladů na snížení emisí skleníkových plynů vypracoval na zakázku britské vlády tým pod vedením profesora ekonomie Nicholase Sterna v roce 2006. Zpráva zdůrazňuje, že vědecké závěry o změnách klimatu jsou spolehlivé, zároveň však není možné předpovědět s jistotou, kdy a jakým způsobem se dopady projeví. Proto tým modeloval nejistotu a rizika pomocí moderních ekonomických nástrojů a porovnal odhady nákladů založené na různých metodologických postupech. Zpráva nejprve analyzuje ekonomické náklady klimatických změn a cenu jejich mitigace, následně se zaměřuje na nejúčinnější opatření pro snížení emisí skleníkových plynů."
...
summary: |
    Poselství Sternovy zprávy je stručné: **okamžitá a účinná opatření na zmírnění klimatických změn se z ekonomického pohledu jednoznačně vyplatí.** Z dlouhodobého pohledu se jedná o strategii umožňující budoucí hospodářský růst a při vhodném provedení nebude omezovat růstové ambice rozvojových, ale ani rozvinutých zemí. Odhadovaná cena dopadů klimatických změn je v rozsahu 5-20 % každoročního celosvětového HDP (hrubého domácího produktu), oproti tomu náklady na snížení emisí skleníkových plynů jsou přibližně 1 % HDP. Čím dříve potřebná opatření přijmeme, tím levnější bude jejich cena.
---

## Shrnutí 

Pokud nebudeme jednat, skleníkové plyny v atmosféře mohou na konci století dosáhnout trojnásobného množství oproti předindustriálnímu období (280 ppm), v takovém případě by teplota s 50% pravděpodobností narostla o více než 5 °C. Pro ilustraci, 5 °C je teplotní rozdíl mezi dnešní dobou a poslední dobou ledovou a takové oteplení by mělo dramatické dopady na civilizaci: roztání ledovců by ohrozilo šestinu populace nedostatkem pitné vody, došlo by k výraznému poklesu výnosů v zemědělství a zvýšená mořská hladina by každoročně ohrožovala povodněmi až stovky milionů osob, kteří dnes žijí mimo záplavová území. Při současném vývoji mohou jen škody způsobené extrémními výkyvy počasí stát 0,5-1 % HDP již v polovině tohoto století a následně dále narůstat. 

#### 1. Analýza nákladů způsobených klimatickými změnami

**Ekonomické náklady klimatických změn (bez přijatých opatření na {% include glossary.html id='mitigace' %}) jsou odhadovány na snížení celosvětového a každoročního HDP o nejméně 5 %** (v sekci Předpoklady a metodologie níže je přesnější popis, co to znamená). Zároveň zpráva upozorňuje, že se jedná o konzervativní odhad a skutečné dopady mohou být násobně vyšší:
