...
Významnou měrou se tato symbióza podílí na odolnosti kořenového systému před průnikem patogenních organismů (především škodlivých hub) a účastní se dalších funkcí podporujících přirozenou obranyschopnost stromu[^22].
...
Oproti tomu *nepasečný* neboli *výběrný způsob hospodaření* je z hlediska těžby náročnější (využívání koní, označování jednotlivých stromů určených ke smýcení a podobně), je ale také k lesu i lesnímu ekosystému mnohem šetrnější a těžební zásah ve srovnání s holosečí prakticky není vidět[^25]. Různé typy sečí a jejich vliv na podobu lesa ukazuje schématicky následující obrázek:  
